...
- 结论：模块拆分方向合理，但任务管理尚未形成统一入口和完整的端云协议。当前 PR 存在合并前应修复的功能问题，不能按“P1–P4 已全部验收，只剩真机”判断。
...
6. 补组合回归，再做真机“机场→换车站→第二个”“机场列表→改去唯一酒店”“空闲待选断线→点击”“思考超时后旧列表”“点击与语音同到”。修复前不建议合并/部署本 PR。
