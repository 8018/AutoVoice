/*
 * JNI 桥：com.autovoice.audiofrontend.ecnr.RnnoiseNative
 *
...
Java_com_autovoice_audiofrontend_ecnr_RnnoiseNative_create(JNIEnv *env, jclass clazz)
{
    (void) env; (void) clazz;
...
Java_com_autovoice_audiofrontend_ecnr_RnnoiseNative_destroy(JNIEnv *env, jclass clazz, jlong handle)
{
    (void) env; (void) clazz;
...
Java_com_autovoice_audiofrontend_ecnr_RnnoiseNative_processFrame(JNIEnv *env, jclass clazz, jlong handle, jshortArray frame)
{
    (void) clazz;
