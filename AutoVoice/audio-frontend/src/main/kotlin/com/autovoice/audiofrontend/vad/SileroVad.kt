 ...
 *
 * 模型：`audio-frontend/src/main/assets/silero_vad.onnx`（snakers4/silero-vad v5 导出，~2.3MB，
...
class SileroVad private constructor(
    ...
    @Volatile
    override var maxProbability = 0f
        private set
    ...
    /** A new capture turn must not inherit recurrent model state or context from the previous one. */
    override fun reset() {
