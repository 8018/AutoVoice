 ...
 *
 * JNI 符号名按包名 `com.autovoice.audiofrontend.ecnr.RnnoiseNative` 声明，
 * 对应 C 侧 `Java_com_autovoice_audiofrontend_ecnr_RnnoiseNative_*`（见 src/main/cpp/）。
 */
 ...
 */
class RnnoiseProcessor : FrontendSignalProcessor {
    ...
    override fun process(frame480: ShortArray): ShortArray {
